...
# You might need BiocManager to install pathview, clusterProfiler and topGO.
# To do so, use biocManager::install("packagename")
...
# Import the .csv-file and make it a dataframe
